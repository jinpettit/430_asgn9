...
print("Expecting 1. Got:")
print(num_sub({ NumV(2), NumV(1) }).n)

print("Expecting 10. Got:")
...
print("Expecting NumC('1'). Got:")
print(exprToString(parse(1)))

print("Expecting IfC(NumC('1') NumC('2') NumC('3')). Got:")
print(exprToString(parse({ 1, '?', 2, 'else:', 3 })))

-- doens't work
print("Expecting BlamC((x, y) {IdC('+'), IdC('x'), IdC('y')})")
print(exprToString(parse({ "blam", { "x", "y" }, { "+", "x", "y" } })))

serialize_test3 = StrV("hi")
print("Expecting hi. Got:")
print(serialize(serialize_test3))

serialize_test1 = NumV(9)
print("Expecting 9. Got:")
print(serialize(serialize_test1))

serialize_test2 = CloV({ IdC("x"), AppC(IdC("+"), { IdC("x"), NumC(1) }) }, { NumC(2) })
print("Expecting #<procedure>. Got:")
print(serialize(serialize_test2))
